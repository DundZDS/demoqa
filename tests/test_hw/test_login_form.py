...
def test_dropdown_state(browser):
    form_page = FormPage(browser)
    form_page.visit()
    time.sleep(2)
    form_page.dropdown_state.scroll_to_element()
    time.sleep(2)
    form_page.dropdown_state.click()
    form_page.dropdown_state.send_keys(Keys.PAGE_DOWN)
    form_page.dropdown_state.send_keys(Keys.ENTER)

    time.sleep(2)
    form_page.dropdown_city.click()
    form_page.dropdown_city.send_keys('Delhi')
    form_page.dropdown_city.send_keys(Keys.ENTER)
